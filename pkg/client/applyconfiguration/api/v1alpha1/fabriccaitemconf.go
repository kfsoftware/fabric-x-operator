...
type FabricCAItemConfApplyConfiguration struct {
	...
	CFG          *FabricCAItemCFGApplyConfiguration          `json:"cfg,omitempty"`
	CSR          *FabricCACSRApplyConfiguration              `json:"csr,omitempty"`
	CRL          *FabricCACRLApplyConfiguration              `json:"crl,omitempty"`
	Registry     *FabricCAItemRegistryApplyConfiguration     `json:"registry,omitempty"`
	Intermediate *FabricCAItemIntermediateApplyConfiguration `json:"intermediate,omitempty"`
	Affiliations []FabricCAAffiliationApplyConfiguration     `json:"affiliations,omitempty"`
	BCCSP        *FabricCAItemBCCSPApplyConfiguration        `json:"bccsp,omitempty"`
...
func (b *FabricCAItemConfApplyConfiguration) WithCFG(value *FabricCAItemCFGApplyConfiguration) *FabricCAItemConfApplyConfiguration {
	b.CFG = value
	return b
}
...
func (b *FabricCAItemConfApplyConfiguration) WithRegistry(value *FabricCAItemRegistryApplyConfiguration) *FabricCAItemConfApplyConfiguration {
	b.Registry = value
	return b
}
...
func (b *FabricCAItemConfApplyConfiguration) WithIntermediate(value *FabricCAItemIntermediateApplyConfiguration) *FabricCAItemConfApplyConfiguration {
...
func (b *FabricCAItemConfApplyConfiguration) WithBCCSP(value *FabricCAItemBCCSPApplyConfiguration) *FabricCAItemConfApplyConfiguration {
	b.BCCSP = value
	return b
}
