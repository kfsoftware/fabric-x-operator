...
type IdentityApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *IdentitySpecApplyConfiguration   `json:"spec,omitempty"`
	Status                           *IdentityStatusApplyConfiguration `json:"status,omitempty"`
}

// Identity constructs a declarative configuration of the Identity type for use with
// apply.
func Identity(name, namespace string) *IdentityApplyConfiguration {
...
func (b *IdentityApplyConfiguration) WithSpec(value *IdentitySpecApplyConfiguration) *IdentityApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *IdentityApplyConfiguration) WithStatus(value *IdentityStatusApplyConfiguration) *IdentityApplyConfiguration {
	b.Status = value
	return b
}
