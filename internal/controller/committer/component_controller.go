...
type ComponentController interface {
	...
	Reconcile(ctx context.Context, committer *fabricxv1alpha1.Committer, config *fabricxv1alpha1.ComponentConfig) error

	// Cleanup cleans up the component resources
	Cleanup(ctx context.Context, committer *fabricxv1alpha1.Committer, config *fabricxv1alpha1.ComponentConfig) error
}
...
func (r *BaseComponentController) reconcileCertificates(
	...
	if err := r.CertService.ProvisionComponentCertificates(ctx, committer, componentName, config); err != nil {
...
func (r *BaseComponentController) cleanupCertificates(
	...
	if err := r.CertService.CleanupComponentCertificates(ctx, committer, componentName); err != nil {
