module github.com/kfsoftware/fabric-x-operator/kubectl-fabricx
...
require (
	github.com/kfsoftware/fabric-x-operator v0.0.0
...
replace github.com/kfsoftware/fabric-x-operator => ../
