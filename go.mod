module github.com/kfsoftware/fabric-x-operator
...
require (
	...
	github.com/hyperledger-labs/SmartBFT v0.0.0-20251222105915-424e45b7a9fb // indirect
...
require (
	...
	github.com/hyperledger/fabric-x-orderer v0.0.24
